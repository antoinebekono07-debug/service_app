...
import 'package:lotech/provider/timeSlots/components/days_component.dart';
import 'package:lotech/provider/timeSlots/components/disclaimer_widget.dart';
import 'package:lotech/provider/timeSlots/components/slot_component.dart';
import 'package:lotech/provider/timeSlots/edit_time_slot_screen.dart';
import 'package:lotech/provider/timeSlots/models/slot_data.dart';
import 'package:lotech/provider/timeSlots/services/time_slot_services.dart';
...
class _MyTimeSlotsScreenState extends State<MyTimeSlotsScreen> {
  ...
  Widget build(BuildContext context) {
    List<String> temp = timeSlotsList.isNotEmpty ? timeSlotsList.firstWhere((element) => element.day!.toLowerCase() == dayListMap[selectedDay], orElse: () => SlotData(slot: [], day: '')).slot.validate() : [];
