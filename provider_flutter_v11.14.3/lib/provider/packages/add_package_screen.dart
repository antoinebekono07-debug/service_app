...
import 'package:lotech/app_theme.dart';
import 'package:lotech/components/app_widgets.dart';
import 'package:lotech/components/custom_image_picker.dart';
...
import 'package:lotech/provider/packages/components/selected_service_component.dart';
import 'package:lotech/provider/packages/select_service_screen.dart';
...
class _AddPackageScreenState extends State<AddPackageScreen> {
  ...
  void init() async {
    ...
    appStore.setSelectedLanguage(localeLanguageList.firstWhere((element) => element.languageCode == DEFAULT_LANGUAGE));
    if (isUpdate) {
                ...
                Row(
                  children: [
                    ...
                    DropdownButtonFormField<StaticDataModel>(
                      ...
                      initialValue: packageStatusModel != null ? packageStatusModel : statusListStaticData.first,
